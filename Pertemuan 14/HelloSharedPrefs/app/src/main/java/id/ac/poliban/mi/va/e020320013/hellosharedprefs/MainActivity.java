package id.ac.poliban.mi.va.e020320013.hellosharedprefs;
...
public class MainActivity extends AppCompatActivity {
    ...
    private String sharedPrefFile = "id.ac.poliban.mi.va.e020320013.hellosharedprefs";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar()!=null)getSupportActionBar().setTitle("Hello Shared Prefs Mila ");
