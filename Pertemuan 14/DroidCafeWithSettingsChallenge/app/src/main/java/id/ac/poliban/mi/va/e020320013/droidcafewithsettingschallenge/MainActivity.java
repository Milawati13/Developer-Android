...
package id.ac.poliban.mi.va.e020320013.droidcafewithsettingschallenge;
...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_MESSAGE =
            "id.ac.poliban.mi.va.e020320013.droidcafewithsettingschallenge.extra.MESSAGE";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar()!=null)getSupportActionBar().setTitle("Droid Cafe Challenge Mila");
